        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="respuesta_valor" value="<?php echo $this->getObjectVariable($this->filters, 'respuesta_valor') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="respuesta_pregunta">
	                        ...
	                        <?php foreach ($this->list_respuesta_pregunta as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'respuesta_pregunta') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
					<label>respuesta_usuario</label>
	                <label class="input-group">
						<div class="input-group-prepend">
	                    ...
	                    <select class="form-control" name="respuesta_usuario">
	                        ...
	                        <?php foreach ($this->list_respuesta_usuario as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'respuesta_usuario') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->respuesta_id; ?>
					<tr>
						<td><?=$content->respuesta_valor;?></td>
						<td><?= $this->list_respuesta_pregunta[$content->respuesta_pregunta];?>
						<td><?= $this->list_respuesta_usuario[$content->respuesta_usuario];?>
						<td class="text-right">
							<div>

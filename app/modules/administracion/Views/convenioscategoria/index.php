        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="convenios_categoria_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'convenios_categoria_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="convenios_categoria_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'convenios_categoria_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->convenios_categoria_id; ?>
					<tr>
						<td><?=$content->convenios_categoria_nombre;?></td>
						<td>
							<?php if($content->convenios_categoria_imagen) { ?>
								<img src="/images/<?= $content->convenios_categoria_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->convenios_categoria_imagen; ?></div>
						</td>
						<td>

        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="formato_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'formato_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Seccion</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="formato_seccion">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_formato_seccion as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'formato_seccion') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->formato_id; ?>
					<tr>
						<td><?=$content->formato_nombre;?></td>
						<td><?= $this->list_formato_seccion[$content->formato_seccion];?>
						<td>

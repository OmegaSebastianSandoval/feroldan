...
<div class="container-fluid">
	<form action="<?php echo $this->route."?pregunta=".$this->pregunta.""; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="opcion_pregunta" value="<?php echo $this->getObjectVariable($this->filters, 'opcion_pregunta') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
    ...
    <div align="center">
	    ...
	    <?php
	        ...
	        if ($this->totalpages > 1) {
	            if ($this->page != 1)
	                echo '<li class="page-item" ><a class="page-link"  href="'.$url.'?page='.($this->page-1).'&pregunta='.$this->pregunta.'"> &laquo; Anterior </a></li>';
	            for ($i=1;$i<=$this->totalpages;$i++) {
	                if ($this->page == $i)
	                    echo '<li class="active page-item"><a class="page-link">'.$this->page.'</a></li>';
	                else
	                    echo '<li class="page-item"><a class="page-link" href="'.$url.'?page='.$i.'&pregunta='.$this->pregunta.'">'.$i.'</a></li>  ';
	            }
	            if ($this->page != $this->totalpages)
	                echo '<li class="page-item"><a class="page-link" href="'.$url.'?page='.($this->page+1).'&pregunta='.$this->pregunta.'">Siguiente &raquo;</a></li>';
	        }
	  	?>
	  	</ul>
	</div>
	<div class="content-dashboard">
	    <div class="franja-paginas">
		    <div class="row">
		    	...
		    	<div class="col-3">
		    		<div class="text-right"><a class="btn btn-sm btn-success" href="<?php echo $this->route."\manage"."?pregunta=".$this->pregunta.""; ?>"> <i class="fas fa-plus-square"></i> Crear Nuevo</a></div>
		    	</div>
		    </div>
	    </div>
							  	...
							  	<div class="modal-dialog" role="document">
							    	<div class="modal-content">
								      ...
								      <div class="modal-footer">
								        	...
								        	<a class="btn btn-danger" href="<?php echo $this->route;?>/delete?id=<?= $id ?>&csrf=<?= $this->csrf;?><?php echo ''.'&pregunta='.$this->pregunta; ?>" >Eliminar</a>
								      </div>
							    	</div>
							  	</div>
							</div>

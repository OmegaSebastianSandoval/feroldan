        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="fotos_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'fotos_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="fotos_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'fotos_imagen') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Album</label>
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->fotos_id; ?>
					<tr>
						<td><?=$content->fotos_nombre;?></td>
						<td>
							<?php if($content->fotos_imagen) { ?>
								<img src="/images/<?= $content->fotos_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->fotos_imagen; ?></div>
						</td>

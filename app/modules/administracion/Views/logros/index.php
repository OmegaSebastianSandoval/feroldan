        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="logros_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'logros_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="logros_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'logros_imagen') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Final</label>
		            ...
		            <input type="text" class="form-control" name="logros_final" value="<?php echo $this->getObjectVariable($this->filters, 'logros_final') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
	                <label>Fecha</label>
	                ...
	                <input type="text" class="form-control" name="logros_fecha" value="<?php echo $this->getObjectVariable($this->filters, 'logros_fecha') ?>"></input>
	                    </label>
	            </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->logros_id; ?>
					<tr>
						<td><?=$content->logros_nombre;?></td>
						<td>
							<?php if($content->logros_imagen) { ?>
								<img src="/images/<?= $content->logros_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->logros_imagen; ?></div>
						</td>
						<td><?=$content->logros_final;?></td>
						<td><?=$content->logros_fecha;?></td>
						<td>

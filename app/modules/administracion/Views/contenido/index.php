						...
						<tr>
							...
							<td class="text-right">
								<div>
									...
									<?php if (($content->contenido_tipo == 16 and !$content->contenido_archivo) || ($content->contenido_tipo == 17 && !$content->contenido_archivo && !$content->contenido_archivo) || ($content->contenido_tipo == 18 && !$content->contenido_archivo) || ($content->contenido_tipo == 19 && !$content->contenido_archivo)) { ?>


										
										<a class="btn btn-verde btn-sm" href="<?php echo $this->route; ?>?padre=<?= $id ?>" data-toggle="tooltip" data-placement="top" title="Documentos"><i class="fas fa-file-upload"></i></a>
									<?php } ?>
									<?php if ($content->contenido_tipo == 15) { ?>
										<a class="btn btn-verde btn-sm" href="<?php echo $this->route; ?>?padre=<?= $id ?>" data-toggle="tooltip" data-placement="top" title="Secciones documentos"><i class="fas fa-file"></i></a>
									<?php } ?>
									<a class="btn btn-azul btn-sm" href="<?php echo $this->route; ?>/manage?id=<?= $id ?>" data-t oggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-pen-alt"></i></a>

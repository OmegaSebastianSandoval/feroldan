        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="contacto_cargo" value="<?php echo $this->getObjectVariable($this->filters, 'contacto_cargo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Correo</label>
		            ...
		            <input type="text" class="form-control" name="contacto_correo" value="<?php echo $this->getObjectVariable($this->filters, 'contacto_correo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="contacto_telefono" value="<?php echo $this->getObjectVariable($this->filters, 'contacto_telefono') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->contacto_id; ?>
					<tr>
						<td><?=$content->contacto_cargo;?></td>
						<td><?=$content->contacto_correo;?></td>
						<td><?=$content->contacto_telefono;?></td>
						<td>

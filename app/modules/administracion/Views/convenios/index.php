        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="convenios_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'convenios_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="convenios_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'convenios_imagen') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="convenios_categoria">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_convenios_categoria as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'convenios_categoria') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->convenios_id; ?>
					<tr>
						<td><?=$content->convenios_nombre;?></td>
						<td>
							<?php if($content->convenios_imagen) { ?>
								<img src="/images/<?= $content->convenios_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->convenios_imagen; ?></div>
						</td>
						<td><?= $this->list_convenios_categoria[$content->convenios_categoria];?>
						<td>

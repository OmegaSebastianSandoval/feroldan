			...
			<div class="pading-dashboard">
				...
				<div class="row">
					...
					<div class="col-12 form-group">
						<label for="info_pagina_informacion_contacto" class="form-label">Información Contacto Parte Izquierda :</label>
...
<!-- 					<div class="col-6 form-group">
						<label for="info_pagina_informacion_contacto_derecha" class="form-label">Información Contacto Parte Derecha:</label>
						<textarea name="info_pagina_informacion_contacto_derecha" id="info_pagina_informacion_contacto_derecha" class="form-control tinyeditor" rows="10"><?= $this->content->info_pagina_informacion_contacto_derecha; ?></textarea>
					</div> -->

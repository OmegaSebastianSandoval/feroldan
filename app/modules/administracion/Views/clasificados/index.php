        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="clasificados_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'clasificados_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="clasificados_categoria">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_clasificados_categoria as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'clasificados_categoria') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="clasificados_documento" value="<?php echo $this->getObjectVariable($this->filters, 'clasificados_documento') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="clasificados_telefono" value="<?php echo $this->getObjectVariable($this->filters, 'clasificados_telefono') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Estado</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="clasificados_estado">
	                        ...
	                        <?php foreach ($this->list_clasificados_estado as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'clasificados_estado') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->clasificados_id; ?>
					<tr>
						<td><?=$content->clasificados_nombre;?></td>
						<td><?= $this->list_clasificados_categoria[$content->clasificados_categoria];?>
						<td><?=$content->clasificados_documento;?></td>
						<td><?=$content->clasificados_telefono;?></td>
						<td><?= $this->list_clasificados_estado[$content->clasificados_estado];?>
						<td>

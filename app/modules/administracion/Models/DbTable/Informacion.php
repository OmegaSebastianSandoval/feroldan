...
class Administracion_Model_DbTable_Informacion extends Db_Table
{
	...
	public function insert($data){
		...
		$info_pagina_informacion_contacto_derecha = $data['info_pagina_informacion_contacto_derecha'];

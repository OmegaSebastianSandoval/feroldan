...
class Administracion_categoriasController extends Administracion_mainController
{
	...
	{
		$title = "Aministración de categorias";
	...
	/**
     * Inserta la informacion de un categorias  y redirecciona al listado de categorias.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y Actualiza la informacion de un categorias  y redirecciona al listado de categorias.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y elimina un categorias  y redirecciona al listado de categorias.
     *
     * @return void.
     */
    ...
    protected function filters()
    {
        if ($this->getRequest()->isPost()== true) {
            ...
            $parramsfilter = array();
					$parramsfilter['categorias_nombre'] =  $this->_getSanitizedParam("categorias_nombre");Session::getInstance()->set($this->namefilter, $parramsfilter);
        }

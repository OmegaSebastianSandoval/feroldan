...
class Administracion_contenidoController extends Administracion_mainController
{
	...
	public function manageAction()
	{
		...
		if($contentpadre->contenido_tipo == 1){
			...
			$this->_view->tipo = 9;
		} else if ($contentpadre->contenido_tipo == 13) {
			$this->_view->tipo = 14;
	...
	private function getContenidoseccion()
	{
		$array = array();
		$array['1'] = 'Home';
		$array['2'] = 'Convenios Titulo';
		$array['3'] = 'Convenios';
		$array['4'] = 'Noticias';
		$array['5'] = 'Empresas';
		$array['6'] = 'Somos la solución';
		$array['7'] = 'Nosotros';
		$array['8'] = 'Creditos';
		$array['9'] = 'Tratamiento de Datos';
		$array['10'] = 'Ahorro';
		$array['11'] = 'Bienestar Social';
		$array['12'] = 'Formulario PQRS';
		$array['13'] = 'Servicios';
		$array['14'] = 'Reglamentos';
		$array['15'] = 'Formatos';
		$array['16'] = 'Circulares de Asamblea';
		$array['17'] = 'Circulares Informativas';
		$array['65'] = "Prueba";
		return $array;
	}

<!-- <div class="titulo-internas" style="background-image:url(/skins/page/images/fondo2.png)">
    <div align="center"><h2>Circulares Informativas</h2></div>
</div>
 -->
 <div class="titulo-internas" style="background-image:url(/skins/page/images/fondo2.png)">
    <div class="container">
        <div align="left">
            <h2 class=" ml-4">Circulares Informativas</h2>
        </div>

    </div>
</div>
<div class="mt-4 mb-4">
<?php echo $this->circularesinformativasdocs; ?>
</div>
...
<div class="formatos">
    <div class="container">
        ...
        <?php foreach ($this->circularesinformativas as $key => $formato) { ?>
            <ul>
                <li>
